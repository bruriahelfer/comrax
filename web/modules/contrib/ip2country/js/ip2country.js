    ...
    attach: function () {
      ...
      $('#edit-ip2country-update-database').click(function () {
        var databaseUpdated = function (data) {
          ...
          $('#throbber').removeClass('working').html(result['message'] + '  ' + result['count']).addClass('completed');
        };
        $('#throbber').removeClass('message completed').addClass('working').html(Drupal.t('Working...'));
